...
public class PhoneDialerActivity extends AppCompatActivity {
    ...
    private AppButtonListener appListener = new AppButtonListener();
    private class AppButtonListener implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appButton = (ImageButton)findViewById(R.id.app);
        appButton.setOnClickListener(appListener);
    }
}
